                ...
                <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
                    ...
                    >
                        <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl">
                            {t("hero.headline1")} <strong>{t("hero.headline2")} </strong>
                            <br />
                            {t("hero.headline3")} <em className="italic font-serif text-gradient"> {t("hero.headline4")} </em>
                        </h1>
                    </motion.div>
                    ...
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center gap-8">
                            <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(56,189,248,0.5)] transition-all duration-300">
                                <img src="/newuu_logo.png" alt="NewUU" className="h-15 object-contain" />
                            </div>
                            <div className="opacity-60 grayscale hover:opacity-100 hover:grayscale-0 hover:drop-shadow-[0_0_8px_rgba(56,189,248,0.5)] transition-all duration-300">
                                <img
